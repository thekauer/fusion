...
Type::Type(const std::string& name,TypeKind tk, By pass, bool mut, const unsigned int size,
           bool optional)
...
Type::TypeKind Type::getTypeKind() {
  return tk;
}
Type::By Type::getBy() {
  return pass;
...
IntegralType::IntegralType(const std::string& name,Ty ty, const unsigned int size)
    : Type(name,Type::Integral, Type::Val, false, size, false), ty(ty) {}

StructType::StructType(const std::string& name,const std::vector<TypedValue> &members)
    : Type(name,Type::Struct, Type::Val, false, struct_size(members), false),
      members(members){};

TupleType::TupleType(const std::string& name,const std::vector<Type *> &members)
